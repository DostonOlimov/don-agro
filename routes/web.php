...
Route::group(
    ...
    function () {
        ...
        Route::group(['prefix' => 'sifat-sertificates'], function () {
            ...
            Route::get('/add_result/{app}', ['as'=>'sifat-sertificates.add_result', 'uses' => '\App\Http\Controllers\SifatSertificateController@addResult']);
            Route::post('/result_store/{app}', ['uses' => '\App\Http\Controllers\SifatSertificateController@ResultStore']);
            Route::get('/add_client/{app}', ['as'=>'sifat-sertificates.add_client', 'uses' => '\App\Http\Controllers\SifatSertificateController@addClientData']);
            Route::post('/client_store/{app}', ['uses' => '\App\Http\Controllers\SifatSertificateController@ClientDataStore']);

            Route::get('/edit/{app}', [ 'uses' => '\App\Http\Controllers\SifatSertificateController@edit'])->name('sifat_sertificate.edit');
            Route::get('/edit-data/{app}', [ 'uses' => '\App\Http\Controllers\SifatSertificateController@editData']);
            Route::post('/update/{app}', '\App\Http\Controllers\SifatSertificateController@update')->name('sifat_sertificate/update');
            Route::get('/view/{app}', '\App\Http\Controllers\SifatSertificateController@showapplication')->name('sifat_sertificate.view');
            Route::get('/accept/{app}', ['as' => '/sifat-sertificates/accept', 'uses' => '\App\Http\Controllers\SifatSertificateController@accept']);
         ...
         Route::group(['prefix' => 'storage-conclusion'], function () {
            ...
            Route::post('/add_files_store', ['uses' => '\App\Http\Controllers\StorageConclusionController@ResultStore']);
