...
<div id="list-date-filter">
    <div class="show-date btn btn-default filter-button" style="background-color: #3160EE;color:white"><b>{{trans('message.Vaqt bo\'yicha filtrlash')}}</b> <i style="margin-left: 7px;"
