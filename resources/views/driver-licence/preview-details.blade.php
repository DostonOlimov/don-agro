                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                ...
                                                <div class="customer-info-item border-bottom pt-3 fs-16">
                                                    ...
                                                    <span class="customer-info-desc fw-600">JS SHIR:</span>

                                                    <span class="customer-info-text">{{$driverLicence->pinfl}}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="customer-info-item border-bottom pt-3 fs-16">
                                                    <span class="customer-info-desc fw-600">{{ trans('app.SHIR')}}:</span>
                                                    <span class="customer-info-text">{{$driverLicence->pinfl ?: $driverLicence->inn}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
