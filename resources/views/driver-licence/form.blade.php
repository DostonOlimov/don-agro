...
{{--    @if (CheckAccessUser('driver_lic', 'create'))--}}
                                        ...
                                        <select class="form-control select-customer" name="customer_id"
                                            ...
                                            @if(!empty($customer))
                                                ...
                                                <option value="{{$customer->id}}" selected="selected">
                                                    ...
                                                    {{$customer->full_name . ' ('.$customer->ownership_form.')'}}
                                                ...
                                                <div class="row types-row">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="material-switch pull-right">
                                                                    ...
                                                                    <input id="A" value="A" name="types[0][name]"
                                                                           type="checkbox"/>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="true"
                                                                   ...
                                                                   name="types[0][date]" autocomplete="off"
                                                                   disabled='disabled' class="form-control given-date">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input style="background-color: white !important;"
                                                                   disabled="" class="form-control duration"
                                                                   name="types[0][duration]" type="number"
                                                                   name="duration" min="0" step="1">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="material-switch pull-right">
                                                                    ...
                                                                    <input id="B" value="B" name="types[1][name]"
                                                                           type="checkbox"/>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="true"
                                                                   style="background-color: white !important;"
                                                                   name="types[1][date]" autocomplete="off"
                                                                   disabled='disabled' class="form-control given-date">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input style="background-color: white !important;"
                                                                   disabled="" class="form-control duration"
                                                                   name="types[1][duration]" type="number"
                                                                   name="duration" min="0" step="1">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="material-switch pull-right">
                                                                    ...
                                                                    <input id="C" value="C" name="types[2][name]"
                                                                           type="checkbox"/>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="true"
                                                                   style="background-color: white !important;"
                                                                   name="types[2][date]" autocomplete="off"
                                                                   disabled='disabled' class="form-control given-date">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input style="background-color: white !important;"
                                                                   disabled="" class="form-control duration"
                                                                   name="types[2][duration]" type="number"
                                                                   name="duration" min="0" step="1">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="material-switch pull-right">
                                                                    ...
                                                                    <input id="D" name="types[3][name]" value="D"
                                                                           type="checkbox"/>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="true"
                                                                   style="background-color: white !important;"
                                                                   name="types[3][date]" autocomplete="off"
                                                                   disabled='disabled' class="form-control given-date">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input style="background-color: white !important;"
                                                                   disabled="" class="form-control duration"
                                                                   name="types[3][duration]" type="number"
                                                                   name="duration" min="0" step="1">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="material-switch pull-right">
                                                                    ...
                                                                    <input id="E" name="types[4][name]" value="E"
                                                                           type="checkbox"/>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="true"
                                                                   style="background-color: white !important;"
                                                                   name="types[4][date]" autocomplete="off"
                                                                   disabled='disabled' class="form-control given-date">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input style="background-color: white !important;"
                                                                   disabled="" class="form-control duration"
                                                                   name="types[4][duration]" type="number"
                                                                   name="duration" min="0" step="1">
                                                        ...
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <div class="material-switch pull-right">
                                                                    ...
                                                                    <input id="F" name="types[5][name]" value="F"
                                                                           type="checkbox"/>
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly="true"
                                                                   style="background-color: white !important;"
                                                                   name="types[5][date]" autocomplete="off"
                                                                   disabled='disabled' class="form-control given-date">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input style="background-color: white !important;"
                                                                   disabled="" class="form-control duration"
                                                                   name="types[5][duration]" type="number"
                                                                   name="duration" min="0" step="1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 col-md-6 form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="series"
                                                               ...
                                                               value="{{$seriesNumber}}" disabled="disabled"
                                                    ...
                                                    <div class="col-6 col-md-6 form-group">
                                                        <label class="form-label">Seriya raqam (viloyat
                                                            bo'yicha)</label>
                                                        <input class="form-control" type="text" name="local_series"
                                                               pattern="[A-Z]{3}"
                                                               @if(!empty($seriesNumber))
                                                               value="{{$seriesNumber}}"
                                                               disabled="disabled"
                                                    ...
                                                    <div class="col-6 col-md-6 form-group">
                                                        ...
                                                        <label class="form-label"
                                                               style="visibility: hidden;">Raqam</label>
                                                        <input class="form-control" type="text" name="local_number"
                                                               required="required"
                                                               @if(!empty($seriesNumber))
                                                               value="{{$seriesNumber}}"
                                                               disabled="disabled"
                                                    ...
                                                    <div class="col-6 form-group recover-field">
                                                        ...
                                                        <select url='0' class="select-recover-reason form-control"
                                                                name="recover_reason">
                                                            <option value=""></option>
                                                            <option data-payment-id="{{$payment_r->firstWhere('key_payment', 'lost')->id}}" value="lost">{{trans('app.reason-lost')}}</option>
                                                            <option data-payment-id="{{$payment_r->firstWhere('key_payment', 'invalid')->id}}" value="invalid">{{trans('app.reason-stolen')}}</option>
                                                            <option data-payment-id="{{$payment_r->firstWhere('key_payment', 'invalid')->id}}" value="invalid">{{trans('app.reason-invalid')}}</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <div id="result-picture"
                                                                     style="width: 32mm; height: 40mm; background-color: #f1f2fd; border: 1px dashed red; margin-bottom: 15px;"></div>
                                                                <button class="btn btn-success picture-button"
                                                                        data-toggle="modal" data-target="#picture-modal"
                                                                        type="button" disabled>Suratga olish
                                                                </button>
                                                            </div>
                                                            <div class="col-8">
                                                                ...
                                                                <div class="has-feedback">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-5">
                                                                            <input type="button" name="fake-image"
                                                                                   class="btn btn-primary"
                                                                                   value="Imzoni yuklash"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <input url='0' class="form-control" type="hidden"
                                                                   name="payment" min="0" disabled
                                                                   @if(!empty($customer))
...
{{--                                                                @include('admin.invoices._customer-invoice-selector', [--}}
{{--                                                                    'category_name' => 'driver_lic',--}}
{{--                                                                    'customerId' => optional($customer)->id,--}}
{{--                                                                    'servingInvoices' => $servingInvoices,--}}
{{--                                                                ])--}}
{{--                                                            </div>--}}
                                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <button class="btn btn-success" type="submit" disabled>Saqlash</button>
                                        <button class="btn btn-success print-button" disabled data-toggle="modal"
                                                data-target="#preview-modal" type="button">Chop etish
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title" id="example-Modal3">Traktorchi-mashinist guvohnomasini chop
                                        etish</h5>
                ...
                {{--   Take picture Modal   --}}
                <div class="col-md-8">
                    <div id="picture-modal" class="modal fade" tabindex="-1" role="dialog"
                         aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div class="float-right btn btn-success" id="take-picture-button">Suratga
                                                olish
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    <script type="text/javascript"
            src="{{ URL::asset('resources/assets/plugins/table-export/blob.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('resources/assets/js/webcam.min.js') }}"></script>

    <script type="text/javascript">
        $(document).ready(function () {
            const paidInvoiceTypeId = $('#paid-button-');
            ...
            $('select.select-customer').select2({
                ajax: {
                    ...
                    processResults: function (data) {
                        data = data.map((item) => {
                            let stateMsg = ''
                            if (item.status !== {{\App\Models\Customer::STATES[\App\Models\Customer::STATE_ACTIVE]}}) {
                                stateMsg = '<span class="text-danger">Faolmas</span>'
                            }

                            return {
                                id: item.id,
                                text: `${item.full_name} ${stateMsg}`,
                                item,
                            }
                        });
                ...
                renderInvoicesList($(this).val())
            });

            $('select[name="recover_reason"]').change(function () {
                paidInvoiceTypeId.val($(this).find(':selected').data('payment-id'))
            ...
            $('#driver-licence-form').one('submit', function (e) {
    ...
    <script
        src="{{ URL::asset('vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}"></script>
