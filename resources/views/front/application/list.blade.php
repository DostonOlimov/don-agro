                                ...
                                <table id="examples1" class="table table-striped table-bordered nowrap display"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom-0 border-top-0">Buyurtmachi korxona yoki tashkilot nomi
                                            </th>
                                        ...
                                        @foreach ($apps as $app)
                                            <tr>
                                                ...
                                                <td><button type="button"
                                                        class="btn btn-round btn-{{ $app->status_color }}">{{ $app->status_name }}</button>
                                                </td>
                                                <td> <a
                                                        href="{!! url('/application/my-application-view/' . $app->id) !!}">{{ $app->app_number == 0 ? '-' : $app->app_number }}</a>
                                                </td>
                                                <td>{{ $app->date }}</td>
                                                <td><a
                                                        href="{!! url('/organization/my-organization-view/' . $app->organization_id) !!}">{{ optional($app->organization)->name }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{!! url('/application/my-application-view/' . $app->id) !!}"><button type="button"
                                                            class="btn btn-round btn-info">{{ trans('app.View') }}</button></a>
                                                    <a url="{!! url('/application/my-application-delete/' . $app->id) !!}" class="sa-warning"> <button
                                                            type="button"
