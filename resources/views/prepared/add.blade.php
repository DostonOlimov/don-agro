                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <form action="{{ url('/prepared/store') }}" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label"
                                                        for="first-name">{{ trans('app.Mahsulot tayorlangan shaxobcha yoki sex nomi') }}
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="first-name">{{ trans('app.Mamlakat nomi') }}
                                                        <label class="text-danger">*</label>
                                                    </label>
                                                    <select name="country" class="w-100 form-control name_of_corn custom-select" id="region" required>
                                                        <option value="">{{ trans('app.Mamlakat nomni tanlang') }}
                                                        </option>
                                                        @if (!empty($countries))
                                            ...
                                            <div class="col-12 col-md-6" id="pre_name" style="display:none">
                                                <div class="form-group">
                                                    <label class="form-label" for="first-name">{{ trans('app.Viloyat nomi') }}
                                                        <label class="text-danger">*</label>
                                                    </label>
                                                    <select name="region" class="region">
                                                        <option value="">{{ trans('app.Viloyat nomni tanlang') }}
                                                        </option>
                                                        @if (!empty($regions))
