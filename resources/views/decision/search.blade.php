            ...
            <div class="page-header" >
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" >
                        <i class="fe fe-life-buoy mr-1"></i>&nbsp {{trans('message.Sertifikatlashtirishni o\'tkazish uchun berilgan ariza bo\'yicha qarorlar ro\'yxati')}}
                    </li>
                </ol>
            </div>
            @if(session('message'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($descion = $app->decision)
                                                    ...
                                                    @else
                                                        <button type="button" class="btn btn-round btn-warning ">{{ trans('app.Yuborilgan')}}</button></a>
                                                    @endif
                                                @else
