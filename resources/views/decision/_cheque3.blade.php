        ...
        <tr>
            <td colspan="4" class="align-left">
                <h4 class=" text-left">
                    ...
                    <span id="crop-type"></span> navli,  &nbsp  mahsulot <span id="crop-name"></span> &nbsp mahsulotini sertifikatlashtirish uchun berilgan arizasini koʼrib chiqib quyidagilarni ma'lum qilamiz:
                </h4>
            </td>
        </tr>
        <tr>
