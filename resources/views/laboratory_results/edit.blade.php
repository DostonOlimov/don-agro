                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="invoice-form" method="post" action="{!! url('laboratory-results/update') !!}" enctype="multipart/form-data"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($indicator->indicator->nd_name)
                                                        ...
                                                        <input class="form-control" step="0.001" value={{$indicator->result}}  name="value{{$indicator->id}}" required>
                                                    @endif
                                                </td>
