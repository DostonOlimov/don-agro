                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <select style="cursor: pointer; " class="w-100 form-control state_of_country custom-select" name="status" id="status">
                                                ...
                                                <option value="3" @if( (  $status == 3))  selected="selected" @endif>{{trans('app.Sinov dasturi shakillantirilmagan')}}</option>
                                                <option value="1" @if( (  $status == 1))  selected="selected" @endif>{{trans('app.Sinov dasturi shakllantirilgan')}}</option>
