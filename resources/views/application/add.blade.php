                            ...
                            <form method="post" action="{!! url('application/store') !!}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <label class="form-label" for="app_number">{{ trans('app.Ariza raqami') }} <label
                                    ...
                                    <div class="col-md-4 form-group {{ $errors->has('dob') ? ' has-error' : '' }}">
                                        <label class="form-label">{{ trans('app.Ariza sanasi') }} <label
                                                class="text-danger">*</label></label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="dd.mm.yyyy" name="dob"
                                                data-mask="00.00.0000" value="{{ old('dob') }}" required />
                                        </div>
                                        @if ($errors->has('dob'))
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group overflow-hidden">
                                            <label class="form-label">{{ trans('app.Ariza turi') }}<label
                                                    class="text-danger">*</label></label>
                                            <select class="w-100 form-control" name="app_type" required>
                                                ...
                                                @foreach ($type as $key => $name)
                                                    <option value="{{ $key }}"
                                                        @if ($key == old('app_type')) selected @endif> {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="organization">
                                                {{ trans('app.Buyurtmachi korxona yoki tashkilot nomi') }} <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <select id="organization" class="form-control owner_search" name="organization"
                                                required>
                                                @if (!empty($organization))
                                                    <option selected value="{{ $organization->id }}">{{ $organization->name }}
                                                    </option>
                                                @endif
                                            </select>
                                            <div>
                                                <a class="btn btn-primary"
                                                    href="{!! url('/organization/add/2') !!}">{{ trans('app.Qo\'shish') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 row">
                                        <div class="form-group">
                                            <label class="form-label" for="prepared">
                                                {{ trans('app.Mahsulot tayorlangan shaxobcha yoki sexning nomi') }} <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <select id="prepared" required class="form-control owner_search2" name="prepared">
                                                @if (!empty($prepared))
                                            ...
                                            <div>
                                                <a class="btn btn-primary"
                                                    href="{!! url('/prepared/add/2') !!}">{{ trans('app.Qo\'shish') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group overflow-hidden">
                                            <label class="form-label">{{ trans('app.O\'lchov turi') }} <label
                                                    class="text-danger">*</label></label>
                                            <select class="w-100 form-control" name="measure_type" required>
                                                ...
                                                @foreach ($measure_types as $key => $name)
                                                    <option value="{{ $key }}"
                                                        @if ($key == old('measure_type')) selected @endif> {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6 form-group has-feedback">
                                        ...
                                        <div class="">
                                            <select required class="form-control requirements" name="requirements[]"
                                                multiple="multiple">
                                    ...
                                    <div class="col-md-8 form-group has-feedback">
                                        <label class="form-label"
                                            for="data">{{ trans('app.Qo\'shimcha ma\'lumotlar') }}<label
                                                class="text-danger">*</label></label>
                                        <div class="">
