							...
							<table id="examples1" class="table table-striped table-bordered nowrap display" style="margin-top:20px;" >
                                ...
                                @endphp
									...
									<tr>
                                        ...
                                        <td><a href="{!! url('/application/view/'.$app->id) !!}"><button type="button" class="btn btn-round btn-{{$app->status_color}}">{{ $app->status_name}}</button></a></td>
                                        <td> <a href="{!! url('/application/view/'.$app->id) !!}">{{ $app->app_number == 0 ? '-' : $app->app_number }}</a></td>
                                        <td>{{ $app->date }}</td>
