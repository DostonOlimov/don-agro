                ...
                <div class="page-header">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <i class="fe fe-life-buoy mr-1"></i>&nbsp {{ trans('message.Normativ hujjatlar') }}
                        </li>
                    </ol>
                </div>
                @if (session('message'))
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div
                                ...
                                @elseif(session('message') == 'nds not found')
                                    <label
                                        for="checkbox-10 colo_success">{{ trans('app.Qaror shakllantirishdan oldin normativ hujjatni qo\'shish kerak') }}</label>
                                @endif
                            </div>
                        </div>
                    </div>
                                            ...
                                            @foreach ($nds as $nd)
                                                <tr>
                                                    ...
                                                    <td style="display: flex; column-gap: 3px;">
                                                        <a href="{!! url('/nds/list/edit/' . $nd->id) !!}"> <button type="button"
                                                                class="btn btn-round btn-success">{{ trans('app.Edit') }}</button></a>
                                                        <a url="{!! url('/nds/list/delete/' . $nd->id) !!}" class="sa-warning"> <button
                                                                type="button"
