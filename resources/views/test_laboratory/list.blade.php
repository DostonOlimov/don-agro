                                    ...
                                    <table id="examples1" class="table table-striped table-bordered nowrap"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0 border-top-0">{{ trans('app.Mahsulot miqdori') }}
                                                </th>
                                                <th class="border-bottom-0 border-top-0">
                                                    {{ trans('app.Ishlab chiqarilgan sana') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($tests as $test)
                                                <tr>
                                                    ...
                                                    <td><a href="{!! url('/tests/laboratory-view/' . $test->id) !!}"><button type="button"
                                                                class="btn btn-round btn-{{ $test->status_color }}">{{ $test->status_name }}</button></a>
                                                    </td>
