                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($accessright as $accessrights)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{!! url('/setting/accessrights/list/edit/' . $accessrights->id) !!}"> <button type="button"
                                                                class="btn btn-round btn-success">{{ trans('app.Edit') }}</button></a>

                                                        <a url="{!! url('/setting/accessrights/list/delete/' . $accessrights->id) !!}" class="sa-warning deletevehicle">
                                                            <button type="button"
