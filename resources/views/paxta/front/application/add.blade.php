                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{!! url('application/my-application-store') !!}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                                    ...
                                                    @if (!empty($countries))
                                                        @foreach ($countries as $name)
                                                            <option value="{{ $name->id }}"
                                                                @if ($name->id == old('country')) selected @endif>
                                                                {{ $name->name }} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                    ...
                                    <div
                                        ...
                                        <input type="text" class="form-control" maxlength="25" name="party_number"
                                            value="{{ old('party_number') }}" required>
                                        ...
                                        <div class="form-group overflow-hidden">
                                            ...
                                            <select class="w-100 form-control" name="measure_type" required>
                                                ...
                                                @foreach ($measure_types as $key => $name)
                                                    <option value="{{ $key }}"
                                                        @if ($key == old('measure_type')) selected @endif>
                                                        {{ $name }} </option>
                                                @endforeach
                                            </select>
                                        </div>
