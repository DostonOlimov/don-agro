        ...
        <div class="d-flex align-items-center justify-content-around" style="width: 86%;">
            ...
            <div class="title title-dashboard" style="width: 100%; text-align: center;">
                <h1 style="text-transform: uppercase; font-size: 1.3rem; margin: 7px 15px">
                    {{ trans('message.Don va uni qayta ishlashdan olingan mahsulotlarni sertifikatlashtirish organi') }}
                </h1>
            </div>
            <div>
                <div class="dropdown">
                    ...
                    <div class="avatar-md">
                        @if (auth()->user()->image)
                            <div style="display: flex; justify-content: center;">
                                <img src="{{ asset('employee/' . auth()->user()->image) }}" style="border-radius: 50%; height: 100%; width: 100%;">
                            </div>
                        @else
