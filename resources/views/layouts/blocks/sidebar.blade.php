<div class="sidebar sidebar-dark sidebar-fixed " id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            @if (auth()->user()->role != \App\Models\User::STATE_EMPLOYEE)
                ...
                {{-- <li class="nav-item"><a class="nav-link" href="{!! url('region-report') !!}">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{!! url('company-report') !!}">
                            ...
                            </svg><?php //echo nl2br(trans('message.Korxonalar kesimida hisobot'));
                            ?></a></li> --}}
                {{-- </ul>
            </li> --}}
            @endif
        ...
        @if (auth()->user()->branch_id == \App\Models\User::BRANCH_INSPECTION or
                auth()->user()->branch_id == \App\Models\User::BRANCH_LABORATORY)
