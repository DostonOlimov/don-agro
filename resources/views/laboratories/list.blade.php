								...
								<?php $i=1;?>
								 @foreach($laboratories as $laboratory)
									<tr>
										...
										<td>{{ $laboratory->certificate }}</td>
										<td>{{ $laboratory->address }}</td>
										<td>
											<a href="{!! url ('/laboratories/edit/'.$laboratory->id) !!}"> <button type="button" class="btn btn-round btn-success">{{ trans('app.Edit')}}</button></a>

											<a url="{!! url('/laboratories/delete/'.$laboratory->id)!!}" class="sa-warning"> <button type="button" class="btn btn-round btn-danger dgr">{{ trans('app.Delete')}}</button></a>
										</td>
									</tr>
								<?php $i++; ?>
								@endforeach
