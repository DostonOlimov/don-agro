                            ...
                            <div class="panel panel-primary">
                                <div class="tab_wrapper page-tab">
                                    <ul class="tab_list">
                                        ...
                                        <li class="active">
                                            <a href="{!! url('/laboratories/list/edit/' . $laboratory->id) !!}">
                                                <span class="visible-xs"></span>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required="required" name="name"
                                                        ...
                                                        class="form-control" value="{{$laboratory->name}}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required="required" name="certificate"
                                                        ...
                                                        class="form-control" value="{{$laboratory->certificate}}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required="required" name="address"
                                                        ...
                                                        class="form-control" value="{{$laboratory->address}}">
                                                </div>
                                            </div>
