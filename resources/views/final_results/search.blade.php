                                    ...
                                    <table id="examples1" class="table table-striped table-bordered nowrap"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0 border-top-0">{{ trans('app.Sinov bayonnomasi sanasi') }}
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($tests as $test)
                                                <tr>
                                                    ...
                                                    <td><a href="{!! url('/application/view/' . $test->application->id) !!}">{{ $test->application->app_number }}</a>
                                                    </td>
                                                    <td>{{ $test->application->date }}</td>
                                                    <td><a
                                                            href="{!! url('/organization/view/' . $test->application->organization->id) !!}">{{ $test->application->organization->name }}</a>
                                                    </td>
                                                    ...
                                                    <td>{{ $test->akt[0]->make_date ?? '' }}</td>
                                                    <td>
                                                        <?php $testid = Auth::User()->id; ?>
                                                        @if ($result = $test->final_result)
                                                            <a href="{!! url('/final_results/view/' . $result->id) !!}"><button type="button"
